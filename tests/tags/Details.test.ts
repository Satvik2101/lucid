...
describe("Details", () => {
    ...
    it("should set tag name as details", () => {
        expect(tag.tagName).toBe("details");
    });
    ...
    it("should set all attributes in factory constructor", () => {
        ...
        tag = Details.withAttributes(attr);
        
        expect(tag.getAttr("open")).toBe(attr["open"]);
    ...
    it("should set open attribute", () => {
        ...
        tag.open(value);
        expect(tag.getAttr("open")).toBe(value);
    });
